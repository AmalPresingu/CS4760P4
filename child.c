...
void signalHandleterminate(){
    printf("CHILD: Handled the SIGTERM signal\n");
    clear_child_shared_mem();
    exit(0);
}
...
int main(int argc, char ** argv){
    ...
    while(1){
        ...
        // generate random number to decide the termination of the process
        float prob = getProb();
        // printf("%f\n",prob);
        // if termination 
    ...
    //send oss the info and random runtime less than the quantum
